import type { StatData, SurveyData, EventData } from './types';
...
export const surveysData: SurveyData[] = [
  { id: 1, title: 'Youth Needs Assessment', meta: '5 questions • 5 min', status: 'pending' },
  { id: 2, title: 'Skills & Interests', meta: 'Completed', status: 'completed' },
  { id: 3, title: 'Community Feedback', meta: '1 day left', status: 'urgent' }
];
...
export const eventsData: EventData[] = [
  ...
  },
  {
    ...
    date: 'Aug 12 • 9:00 AM',
    status: 'available',
    image: 'https://images.unsplash.com/photo-1593113589914-0759972b0e2f?auto=format&fit=crop&q=80&w=200'
  }
];